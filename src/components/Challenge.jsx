        ...
        <>
          ...
          <div key={index} className="container">
            ...
            <div className="video-box">
                ...
                <ReactPlayer className="video-box-video" style={{border: "1px solid rgb(11, 11, 112)"}} url={"https://youtu.be/MHu7UEvOJfU?si=n6utv4YZAZ_27V_c"} controls/>
            </div>
            <div className="video-box">
            ...
            <div className="video-box">
                ...
                <ReactPlayer className="video-box-video" style={{border: "1px solid rgb(11, 11, 112)"}} url={"https://youtu.be/O6uBOb1NQvc?si=p1NojeBSHn8BXnb0"} controls/>
            </div>
            <div className="video-box">
